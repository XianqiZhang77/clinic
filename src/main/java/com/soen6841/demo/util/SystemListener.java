...
public class SystemListener implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Patient> getPatientList(){
        ...
        Patient patient3 = new Patient("Ray", "Ray", "Ray@gmail.com", "Du Fort", "43234545", new Date(19999999), Status.accepted, new Date(), "Above 18 years" , "Yes", "Yes" ,"Yes", new Date(), Status.assigned, "Alice", "Mike");
