...
public class SystemListener implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Doctor> getDoctorList(){
        ...
        Doctor doctor2 = new Doctor("doctor2","Mike","b@gamil.com","B St,","888866666",new Date(19999999),"123", Status.wating);
    ...
    private List<Nurse> getNurseList(){
        ...
        Nurse nurse1 = new Nurse("nurse1","Linda","k@gamil.com","L St,","54768558",new Date(19999999),"1992", Status.wating);
        nurseList.add(nurse1);
        Nurse nurse2 = new Nurse("nurse2","Bill","bikk@gamil.com","Bi St,","8888698699",new Date(288888888),"1236", Status.wating);
